...
$env:AOC = "{path}\Advent_Of_Code_2024" # Change this to your AOC directory
...
function get-aoc {
    ...
    Invoke-WebRequest -Uri "https://adventofcode.com/2024/day/$day/input" -Headers @{ "cookie" = "session=$env:AOC_COOKIE" } -OutFile in.txt
}
...
function new-day {
    ...
    $part1Folder = "$env:AOC\$folderName\Part 1"
    $part2Folder = "$env:AOC\$folderName\Part 2"
